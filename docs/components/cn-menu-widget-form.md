...
Config sub-form for the `menu` widget — style, orientation, items, icons.
...
<!-- AUTO-GENERATED by vue-docgen-cli — do not edit. Source: src/components/CnMenuWidgetForm/CnMenuWidgetForm.vue -->
