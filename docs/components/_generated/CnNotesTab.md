<!-- AUTO-GENERATED by vue-docgen-cli — do not edit. Source: src/components/CnObjectSidebar/CnNotesTab.vue -->
...
| `loadingLabel`       | `string` |          | `() =&gt; t('nextcloud-vue', 'Loading notes…')`        | Text shown while the notes are being fetched              |
| `historyLabel`       | `string` |          | `() =&gt; t('nextcloud-vue', 'Show earlier versions')` | Label for the action that opens a note's earlier versions |
