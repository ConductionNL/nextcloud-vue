<!-- AUTO-GENERATED by vue-docgen-cli — do not edit. Source: src/components/CnXwikiPagePicker/CnXwikiPagePicker.vue -->
...
| `link`  | —       | Emitted when the user confirms the selection. Payload: `{ pageReference }`. |
