...
The tables below are generated from the SFC source via `vue-docgen-cli`. They reflect what's actually in [`CnCopyDialog.vue`](https://codeberg.org/Conduction/nextcloud-vue/src/branch/beta/src/components/CnCopyDialog/CnCopyDialog.vue) and update automatically whenever the component changes.
