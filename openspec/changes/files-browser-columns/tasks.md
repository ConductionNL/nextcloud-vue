...
- **files**: `src/components/CnFilesBrowser/CnFilesBrowser.vue`, `src/components/CnFilesBrowser/filesBrowser.js`, `src/components/__tests__/CnFilesBrowserColumns.spec.js`
- **acceptance_criteria**:
...
- **files**: `src/components/CnFilesBrowser/CnFilesBrowser.vue`, `src/composables/useListView.js`, `src/components/__tests__/CnFilesBrowserColumns.spec.js`
- **acceptance_criteria**:
