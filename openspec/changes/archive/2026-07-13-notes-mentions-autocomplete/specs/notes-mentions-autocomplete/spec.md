# notes-mentions-autocomplete — Delta Spec

`@mention` autocomplete, storage, rendering and notification hook for `CnNotesTab`'s note composer and note list.
