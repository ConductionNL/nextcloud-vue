# cnindexpage-export-action

CnIndexPage and CnDataTable offer CSV/Excel export of OR schema objects via a native toolbar action, delegating serialization to the OpenRegister export leaf.
