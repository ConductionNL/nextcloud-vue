...
- [x] scholiq: replace `SignPlanModal` with a `CnWizardDialog` step hosting `CnSignatureCapture`. [DEFERRED — consumer-repo migration, explicitly "Follow-up (consumer)" per heading.]
