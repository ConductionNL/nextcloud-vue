# Workspace Context Widgets

**Spec refs**: `dashboard-page`, `grid-widget-system`, `component-library`
**Standards**: ADR-022 (apps consume library + OR abstractions), WCAG 2.1 AA (NcSelect input labels, keyboard reachability)
