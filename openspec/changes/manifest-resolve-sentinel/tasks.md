...
- [x] Add `src/utils/resolveManifestSentinels.js` — a pure function
...
- [x] Update `src/composables/useAppManifest.js` to call
...
- [x] Write `specs/manifest-resolve-sentinel/spec.md` with:
...
- [x] After this change merges, update launchpad / larpingapp /
      ...
      on this change. [DEFERRED — consumer-repo migrations, explicitly
      "not blocking PRs on this change" per the task text.]
...
- [x] Reference this change from `hydra/openspec/architecture/adr-024-app-manifest.md`
      ...
      point of the canonical loader. [DEFERRED — lives in the hydra
      repo (separate change); will be folded into the next ADR-024
      revision rather than racing this PR.]
