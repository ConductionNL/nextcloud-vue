...
```
Layer 3: App (Larpinq, Pipelinq, OpenCatalogi, Dossiq, Launchpad, ...)
...
Consumer apps known to use this library: OpenRegister, OpenCatalogi, Dossiq, Pipelinq, Launchpad, Larpinq, Stackiq, ZaakAfhandelApp, Filinq.
