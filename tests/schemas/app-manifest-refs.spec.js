...
describe('app-manifest.schema.json — manifest-config-refs $ref wiring', () => {
	it('schema version is 1.8.0 (1.4.0 adds runtime+visibleIf; 1.5.0 adds menuItem.action; 1.6.0 adds layoutItem.dateChip; 1.7.0 adds top-level credentials[]; 1.8.0 adds HARD/SOFT dependency entries)', () => {
