...
export default {
	...
	methods: {
		/**
		 * Find a schema from availableSchemas by slug, id, or title.
		 *
		 * @param {string} schemaSlug The slug, id, or title to search for
		 * @return {object|undefined} The matching schema or undefined
		 */
		...
		/**
		 * Build cleaned schema data and emit confirm event.
		 * The parent should perform the API call and call setResult().
		 */
		executeConfirm() {
			this.loading = true

			// Clean up schema properties before emitting
