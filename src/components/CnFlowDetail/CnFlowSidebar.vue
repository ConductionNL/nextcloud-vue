...
<template>
	<div class="cn-flow-sidebar">
		...
		<section>
			...
			<NcTextField :value="store.flow.name"
				:label="t('nextcloud-vue', 'Name')"
				@update:value="store.setFlowField('name', $event)" />

			<NcTextField :value="store.flow.description || ''"
				:label="t('nextcloud-vue', 'Description')"
				@update:value="store.setFlowField('description', $event)" />

			<NcSelect :value="triggerOption"
