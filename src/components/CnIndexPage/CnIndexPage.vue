...
export default {
	...
	props: {
		...
		/**
		 * Which view-mode toggle segments to expose, in order. Defaults to the
		 * historical Cards/Table pair; include `'list'` to offer the list view.
		 * Fed from the manifest as `pages[].config.availableViewModes`.
